...
We need to conduct an **initial data analysis** to find and **report problems** that need to be fixed.
...
As a part of the initial data analysis, we need to describe the various variables present in the dataset. The variables may be described as follows:
...
Let us get an understanding of how the data looks like by checking the first few rows.
